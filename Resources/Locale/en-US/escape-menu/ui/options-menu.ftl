...
ui-options-ammo-counter-position = Ammo counter position
ui-options-ammo-counter-position-cursor = Next to cursor
ui-options-ammo-counter-position-hotbar = Above active hand slot
